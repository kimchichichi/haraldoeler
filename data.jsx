...
const DETAILS = {
  solo: {
    ...
    repertoire: [
      ...
      { className: "big", num: "III.", work: "Harald Oeler", note: "»Remembering«", dur: "—" },
      { className: "indent", num: "1.", work: "Remembering Bach", note: "Fantasy & Fugue on two themes by Astor Piazzolla", dur: "" },
      { className: "sub", num: "a.", work: "Fantasy", note: "La misma pena", dur: "" },
      { className: "sub", num: "b.", work: "Fugue", note: "Luz y sombra", dur: "" },
      { className: "indent", num: "2.", work: "Remembering Paris", note: "", dur: "", embed: { type: "instagram", id: "DOiQ1ZWjKfC" } },
      { className: "indent", num: "3.", work: "Remembering Tokyo", note: "Anime-Sonata", dur: "", embed: { type: "instagram", id: "DDH-WF9scl0" } },
      { className: "indent", num: "4.", work: "Remembering Piazzolla", note: "Five Tango-Jamsations", dur: "" },
      { className: "sub", num: "a.", work: "Bando", note: "", dur: "" },
      { className: "sub", num: "b.", work: "Adiós Nonino", note: "", dur: "" },
      { className: "sub", num: "c.", work: "Saint Louis en l'Île", note: "", dur: "" },
      { className: "sub", num: "d.", work: "Imperial", note: "", dur: "" },
      { className: "sub", num: "e.", work: "S.V.P.", note: "", dur: "", embed: { type: "instagram", id: "DDhrKbjstZg" } },
      { num: "IV.", work: "Domenico Scarlatti", note: "Sonate D-Dur, Kk. 29 · III. Presto", dur: "—", embed: { type: "spotify", media: "track", id: "77B0zWaG2CeRMyhwRmfrr9" } },
    ],
    quotes: [
  ...
  duovia: {
    ...
    termine: [
      ...
      { date: "7. Mai 2026", time: "19:30 Uhr", title: "Duo ViA! · Four Seasons – One World", venue: "Mozartareal", city: "Würzburg", note: "" },
      { date: "9. Mai 2026", time: "13:00 Uhr", title: "Duo ViA! · Four Seasons – One World", venue: "Mühlenforum Glattbach", city: "Glattbach", note: "Hauptstraße 56 B" },
  ...
  duoklakk: {
    ...
    termine: [
      { date: "5. Juli 2026", time: "17:00 Uhr", title: "Duo KlAkk! goes Encore!", venue: "Weytterturm (Innenhof)", city: "Straubing", note: "In der Bürg 34 · 94315 Straubing" },
      { date: "19. Juli 2026", time: "09:00 Uhr", title: "BERGKONZERT: Zauber des Akkordeons", venue: "Bergstation Tegelberg", city: "Schwangau", note: "Ort der Besinnung" },
      { date: "13. September 2026", time: "Uhrzeit folgt", title: "Duo KlAkk! goes BACH!", venue: "Ort folgt", city: "", note: "" },
