...
const DETAILS = {
  ...
  duovia: {
    ...
    repertoire: [
      { num: "I.", work: "Antonio Vivaldi", note: "Le quattro stagioni", dur: "" },
      { num: "II.", work: "Astor Piazzolla", note: "Las cuatro estaciones porteñas", dur: "" },
      { num: "III.", work: "J. S. Bach · Chick Corea u.a.", note: "im Wechselspiel", dur: "" },
    ],
    quotes: [
